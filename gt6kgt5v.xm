...
<manifest>
  ...
  <project remote="origin" name="android_kernel_common_oneplus_sm8650" path="kernel_platform/common" revision="oneplus/sm8650_v_15.0.0_oneplus12">
  ...
  <project remote="realme" name="realme_GT5pro-AndroidV-vendor-source" path="./" revision="master" clone-depth="1"/>
